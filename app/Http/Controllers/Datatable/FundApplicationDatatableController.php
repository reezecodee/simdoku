    ...
    public function getFormulirs()
    {
        ...
        return DataTables::of($funds)
            ...
            ->addColumn('tgl_pengajuan', function ($row) {
                return $row->tgl_pengajuan ? Carbon::parse($row->tgl_pengajuan)->translatedFormat('l, d F Y') : 'Belum diatur';
            })
            ->addColumn('tgl_diperlukan', function ($row) {
                return $row->tgl_diperlukan ? Carbon::parse($row->tgl_diperlukan)->translatedFormat('l, d F Y') : 'Belum diatur';
            })
